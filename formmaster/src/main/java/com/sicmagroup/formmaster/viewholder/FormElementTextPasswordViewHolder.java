...
public class FormElementTextPasswordViewHolder extends BaseViewHolder {
    ...
    public FormElementTextPasswordViewHolder(View v, FormItemEditTextListener listener) {
        ...
        mEditTextValue = (AppCompatEditText) v.findViewById(R.id.formElementValue_pass);
        mFormCustomEditTextListener = listener;
        mEditTextValue.addTextChangedListener(mFormCustomEditTextListener);
        mEditTextValue.setRawInputType(InputType.TYPE_NUMBER_VARIATION_PASSWORD|InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS|InputType.TYPE_CLASS_NUMBER);
        mEditTextValue.setTransformationMethod(PasswordTransformationMethod.getInstance());
    }
